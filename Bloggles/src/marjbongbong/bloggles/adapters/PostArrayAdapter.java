...
public class PostArrayAdapter extends ArrayAdapter<Post> {
	...
	public PostArrayAdapter(Context context, int textViewResourceId, ArrayList<Post> posts, Typeface tf) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		default_photo = (ImageView) rowView.findViewById(R.id.default_photo);
		...
		default_photo.setImageResource(p.getDefaultPhoto());
